  ...
  >
    <div className="flex flex-col items-center space-y-3">
      <div className="relative group">
        ...
        />
        <div className="absolute inset-0 bg-secondary/10 rounded-full blur-xl opacity-0 
                      group-hover:opacity-100 transition-opacity duration-300"></div>
      </div>
      <h3 className="text-base font-medium text-textPrimary group-hover:text-secondary transition-colors">{title}</h3>
